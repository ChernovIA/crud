...
public class UsersDAOJPAImpl implements UsersDAO {
        ...
        private EntityManagerFactory emf = DBConnector.getMysqlConfigutarionJPA_test();
        ...
        public User get(String login) throws DBException {
            try {
                TypedQuery<User> tq = entityManager.createQuery("SELECT c FROM User as c WHERE c.login = ?1",User.class);

...
@WebServlet("/administration/editUser")
public class ServletEditUser extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (result.getStatusResults() == DBStatusResults.OK) {
           ...
           // req.setAttribute("isAdmin", result.getData().getRole().equals(Roles.ADMIN));
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        User user = new User(userID,login,password,name, role.toLowerCase());
